...
void dense_optical_flow(string filename, bool save, Method method, bool to_gray,
                        Args&&... args) {
  ...
  while (true) {
    ...
    if (save) {
      string save_path =
          "./optical_flow_frames/frame_" + to_string(counter) + ".jpg";
...
int main(int argc, char** argv) {
  ...
  dense_optical_flow(filename, save, optflow::calcOpticalFlowSparseToDense,
                     to_gray, 8, 128, 0.05f, true, 500.0f, 1.5f);
